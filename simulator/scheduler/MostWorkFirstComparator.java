...
/**
 * Comparator that orders by decreasing estimated service demand of
...
public class MostWorkFirstComparator implements Comparator<Job> {
  ...
  public int compare(Job j1, Job j2) {
    ...
    if(j1val != j2val) {
	return Utility.getSign(j2val-j1val);
    }
  ...
  public boolean equals(Object other) {
    return (other instanceof MostWorkFirstComparator);
  }

  public String toString(){
    return "LongestServiceComparator";
  }
}
